  ...
  return (
    <div className="flex flex-col items-center justify-center bg-primary-dark/80 py-2 relative">
        ...
        <p className="flex items-center gap-1 justify-center">
          Power by
          <a href="https://thecoderbutcher.site" target="_blank" className="text-accent transition-all duration-300">thecoderbutcher</a>
          with
          <span className="text-accent hover:scale-125 ">❤</span></p>
    </div>
  )
}
